...
func (m *SystemInfo) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
var fileDescriptor_1580c0dd88c0be2b = []byte{
	...
	,
}
...
func (m *SystemInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintSystemInfo(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0xa
	}
